...
This thesis therefore asks: \emph{How do six back-end variants, formed by crossing polling and event-driven ingestion with three AWS storage engines (RDS PostgreSQL, Amazon Timestream, DynamoDB), differ in end-to-end update latency, query speed, and resource use when operating at Trafikverket's real-time train-position rate limit?} A statistically robust answer will give practitioners a concrete decision matrix and provide researchers with a reproducible benchmark for future optimisation studies.
