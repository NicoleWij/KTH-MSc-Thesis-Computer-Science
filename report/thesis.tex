...
%%%       – cite Heldt et al., Grzesik et al., Vergara et al., etc.

% ---------------------------------------------------------------
\section{Related Work and Research Gap}
\label{sec:gap}
% ---------------------------------------------------------------
%%% >> Keep this as 2–3 tight paragraphs:
%%%    1. What has been done on ingestion *alone*
%%%    2. What has been done on storage *alone*
%%%    3. Why the combination under a real API rate limit
%%%       has not been explored (your gap)
%%%
%%% Tip: Mention any methods you borrow. This pre-empts Method
%%%      Chapter questions (“inspired by X, we adopt Y test loop …”).
