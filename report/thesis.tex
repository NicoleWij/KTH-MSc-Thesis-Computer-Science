...
Event-driven designs are not cost-free, however. They need message brokers and extra processing to decode each event, and in some small-scale tests, a single, tightly integrated program (a monolith) still handled requests faster than a network of event-driven microservices \cite{Trindade2021EDAImpact}.  
